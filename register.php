    ...
    <div class="wrapper">
        ...
        <div class="login-container">
            <div class="login-form container">
                <form method="POST" action="./php/handler_register.php" class="form">
                    ...
                    <div class="form-group">
                        ...
                        <input style="border-radius: 20px;" type="text" class="form-control" name="name" id=""
                            aria-describedby="helpId" placeholder="Nguyễn Văn An" require>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input style="border-radius: 20px;" type="text" class="form-control" name="address" id="address"
                            aria-describedby="helpId" placeholder="Số nhà, Đường, Quận/Huyện/Thị xã, Thành phố/Tỉnh">
                    </div>
                    <div class="form-group">
                        <label for="phoneNumber">Số điện thoại</label>
                        <input style="border-radius: 20px;" type="text" class="form-control" name="phoneNumber"
                            id="phoneNumber" aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="role">Vai trò</label>
                        <select style="border-radius: 20px;" class="form-control" name="role" id="role">
                            <option>customer</option>
                            <option>shipper</option>
                        </select>
                    </div>
                    <button id="btn-register" type="submit" name="register"
                        style="width: 50%; margin: 10px 25%; color: white;background-color: rgb(8, 175, 241); font-weight: 600; border-radius: 20px;">
                        Đăng kí
                    </button>
                    <div class="register-here">
                        Đã có tài khoản? <a class="register-page" href="login.php">Đăng nhập</a>
                    </div>
